"""
Django settings for football_academy_ireland project.
...
SECRET_KEY = 'django-insecure-pzu@x*eloql^&jubxn$6-j+)v3vz7#zary+adx=gecc4k)nrbk'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['https://git.heroku.com/football--academy--ireland.git' ,'localhost']
